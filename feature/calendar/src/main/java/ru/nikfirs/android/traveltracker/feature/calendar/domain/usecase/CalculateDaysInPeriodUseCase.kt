package ru.nikfirs.android.traveltracker.feature.calendar.domain.usecase
...
class CalculateDaysInPeriodUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        tripExceptionId: Long? = null,
    ): DaysCalculation {
        return tripRepository.calculateDaysInPeriod(periodEnd, tripExceptionId)
    }
}